...
pub struct RwValues<F> {
    ...
    pub value_hi: Expression<F>,
    pub value_lo: Expression<F>,
    pub prev_value_hi: Expression<F>,
    pub prev_value_lo: Expression<F>,
    pub commited_value_hi: Expression<F>,
    pub commited_value_lo: Expression<F>,
    pub aux: Expression<F>,
}
...
impl<F: Field> RwValues<F> {
    ...
    pub fn new(
        ...
        prev_value_hi: Expression<F>,
        prev_value_lo: Expression<F>,
        commited_value_hi: Expression<F>,
        commited_value_lo: Expression<F>,
        aux: Expression<F>,
    ) -> Self {
        Self {
            id,
